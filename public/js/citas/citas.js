...
document
  .getElementById('formRegistroCita')
      ...
      .then((result) => {
        if (result.success) {
          const modal = bootstrap.Modal.getInstance(
            document.getElementById('modalRegistroCita')
          )
          modal.hide()
          this.reset()
          this.classList.remove('was-validated')
          if (window.citasTableInstance) {
            window.citasTableInstance.cargarCitas()
          }
        } else {
    ...
    fetch('/citas/controller/citasController.php?action=listar')
      ...
      .then((citas) => {
        ...
        if (cita) {
          ...
          document.getElementById('nombre_pacienteUpd').value =
          ...
          document.getElementById('nombre_usuarioUpd').value =
            cita.nombre_usuario

          const modal = new bootstrap.Modal(
            document.getElementById('modalActualizarCita')
          )
          modal.show()
        }
      })
